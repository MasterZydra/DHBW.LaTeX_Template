...
\begin{longtable}{p{0.5\linewidth} p{0.5\linewidth}}
    ...
    Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. \\
    \hline
\caption{Hier eine lange Tabelle mit zwei Spalten (je 50\% Breite). Diese könnte auch über mehrere Seiten gehen}
\label{tbl_longtable}
\end{longtable}
...
Eine \acs{Abkürzung} ist eine tolle Sache. Wie man hier auch sehen kann, können Links zu den Einträgen im Abkürzungsverzeichnis erzeugt werden. Ob man es unbedingt braucht?
