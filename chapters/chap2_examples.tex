...
Für langen Inline-Quellcode wird automatisch ein Zeilenumbruch eingefügt: \mintinline{python}{[ x if x%2 else x*100 for x in range(1, 10) ]}. Ein Problem entsteht erst, wenn der Code selbst, länger als eine Zeile ist, dann wird über den Rand geschrieben.
